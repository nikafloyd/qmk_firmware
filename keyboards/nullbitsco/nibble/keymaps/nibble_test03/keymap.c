...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_F2] = LAYOUT_ansi(
    ...
    _______,  _______,  DF(_QW), _______, _______, _______, _______, _______, _______, KC_BTN1, KC_MS_U, KC_BTN2, _______, _______, _______, _______,
    KC_F23,   KC_CALC,  _______, _______, DF(_DV), _______, _______, _______, _______, KC_MS_L, KC_MS_D, KC_MS_R, _______,          _______, _______,
