...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FN] = LAYOUT_ansi(
    ...
    _______,  LCTL_T(KC_CAPS),  _______, _______, _______, _______, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______,          _______, KC_PGUP,
  ...
  [_F2] = LAYOUT_ansi(
    ...
    _______,  _______,  DF(_QW), _______, _______, _______, _______, _______, KC_BTN1, KC_BTN2, _______,  _______, _______, _______, _______, _______,
    KC_F23,   KC_CALC,  _______, _______, DF(_DV), _______, _______, _______, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, _______,          _______, _______,
