...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QW] = LAYOUT_ansi(
    ...
    MO(_F2),  KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,                    MO(_QF), KC_RALT, KC_RCTL, KC_LEFT,          KC_DOWN, KC_RGHT
  ),
  [_QF] = LAYOUT_ansi(
    ...
    KC_MPRV,  _______,          _______, _______, _______, _______, _______, _______, RCTL(KC_LEFT), RCTL(KC_RGHT), _______, _______, _______,          _______, KC_PGDN,
  ...
  [_DV] = LAYOUT_ansi(
    ...
    MO(_F2),  KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,                    MO(_DF), KC_RALT, KC_RCTL, KC_LEFT,          KC_DOWN, KC_RGHT
  ),
  [_DF] = LAYOUT_ansi(
              KC_ESC,           KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, _______,
    RGB_TOG,  _______,          _______, _______, _______, _______, _______, _______, KC_HOME, KC_UP,   KC_END,  KC_PGUP, _______, _______, _______, _______,
    _______,  LCTL_T(KC_CAPS),  _______, _______, _______, _______, KC_ESC,  _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, _______,          _______, KC_PGUP,
    KC_MPRV,  _______,          _______, _______, _______, _______, _______, _______, KC_BSPC, KC_TAB,  _______, _______, _______,          _______, KC_PGDN,
    _______,  _______,          _______, _______,                   _______,                   _______, _______, _______, _______,          _______, _______
  ),
  [_F2] = LAYOUT_ansi(
...
bool oled_task_user(void) {
    ...
    switch (get_highest_layer(layer_state|default_layer_state)) {
        case _QW:
            ...
            break;
        case _QF:
            oled_write_P(PSTR("QW Function\n"), false);
            break;
        case _DV:
            oled_write_P(PSTR("Dvorak\n"), false);
            break;
        case _DF:
            oled_write_P(PSTR("DV Function\n"), false);
            break;
        case _F2:
