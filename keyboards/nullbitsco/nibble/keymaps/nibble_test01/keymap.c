...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FN] = LAYOUT_ansi(
    ...
    RGB_TOG,  _______,  DF(_QW), _______, _______, _______, _______, _______, _______, KC_UP,   _______, _______, _______, _______, _______, _______,
    RESET,    KC_CAPS,  _______, _______, DF(_DV), _______, _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______,          _______, KC_PGUP,
